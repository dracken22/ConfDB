...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 28 jan. 2021 à 02:34
...
--
-- Structure de la table `armies_alliances`
--

DROP TABLE IF EXISTS `armies_alliances`;
CREATE TABLE `armies_alliances` (
  `_army` int(11) NOT NULL,
  `_alliance` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Lien armées - alliances';
...
--
-- Index pour la table `armies_alliances`
--
ALTER TABLE `armies_alliances`
  ADD PRIMARY KEY (`_army`,`_alliance`),
  ADD KEY `armyalliance_alliance` (`_alliance`);
...
ALTER TABLE `sizes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `size_name_label` (`_name`),
  ADD KEY `size_pedestal_label` (`_pedestal`),
  ADD KEY `size_size_label` (`_size`);
...
--
-- Contraintes pour la table `armies_alliances`
--
ALTER TABLE `armies_alliances`
  ADD CONSTRAINT `armyalliance_alliance` FOREIGN KEY (`_alliance`) REFERENCES `alliances` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `armyalliance_army` FOREIGN KEY (`_army`) REFERENCES `armies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `armylists`
--
ALTER TABLE `armylists`
  ADD CONSTRAINT `armylist_army` FOREIGN KEY (`_army`) REFERENCES `armies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `artifacts_alliances`
  ADD CONSTRAINT `artifactalliance_alliance` FOREIGN KEY (`_alliance`) REFERENCES `alliances` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `artifacts_armies`
  ADD CONSTRAINT `artifactarmy_army` FOREIGN KEY (`_army`) REFERENCES `armies` (`id`),
  ADD CONSTRAINT `artifactarmy_artifact` FOREIGN KEY (`_card_artifact`) REFERENCES `card_artifacts` (`_card`);
...
--
ALTER TABLE `card_fighters`
  ADD CONSTRAINT `fighter_army` FOREIGN KEY (`_army`) REFERENCES `armies` (`id`),
  ADD CONSTRAINT `fighter_card` FOREIGN KEY (`_card`) REFERENCES `cards` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fighter_gender` FOREIGN KEY (`_gender`) REFERENCES `genders` (`id`),
  ...
  ADD CONSTRAINT `fighter_rank` FOREIGN KEY (`_rank`) REFERENCES `ranks` (`id`),
  ADD CONSTRAINT `fighter_size` FOREIGN KEY (`_size`) REFERENCES `sizes` (`id`);
...
--
ALTER TABLE `card_fighters_classes`
  ADD CONSTRAINT `fighterclass_class` FOREIGN KEY (`_class`) REFERENCES `classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `magicians`
  ADD CONSTRAINT `magician_rank` FOREIGN KEY (`_rank`) REFERENCES `ranks` (`id`);
...
--
ALTER TABLE `priests`
  ADD CONSTRAINT `priest_rank` FOREIGN KEY (`_rank`) REFERENCES `ranks` (`id`);
...
--
ALTER TABLE `sizes`
  ADD CONSTRAINT `size_name_label` FOREIGN KEY (`_name`) REFERENCES `labels` (`id`),
  ADD CONSTRAINT `size_pedestal_label` FOREIGN KEY (`_pedestal`) REFERENCES `labels` (`id`),
  ADD CONSTRAINT `size_size_label` FOREIGN KEY (`_size`) REFERENCES `labels` (`id`);
